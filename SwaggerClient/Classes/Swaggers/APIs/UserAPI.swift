...
open class UserAPI: APIBase {
     ...
     */
    open class func historyGet(offset: Int32? = nil, limit: Int32? = nil, completion: @escaping ((_ data: InlineResponse2003?,_ error: Error?) -> Void)) {
  ...
  "history" : [ {
     ...
     */
    open class func historyGetWithRequestBuilder(offset: Int32? = nil, limit: Int32? = nil) -> RequestBuilder<InlineResponse2003> {
        let path = "/history"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func meGet(completion: @escaping ((_ data: InlineResponse2002?,_ error: Error?) -> Void)) {
  ...
  "picture" : "aeiou"
     ...
     */
    open class func meGetWithRequestBuilder() -> RequestBuilder<InlineResponse2002> {
        let path = "/me"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters: [String:Any]? = nil
